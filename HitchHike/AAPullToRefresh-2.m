...
@property (nonatomic, strong) TYMActivityIndicatorView *activityIndicatorView;  //Loading Indicator
...
- (void)_commonInit
{
    ...
    [_activityIndicatorView setIndicatorImage:tempImage];
    ...
    if (!self.imageIcon)
        self.imageIcon = [UIImage imageNamed:@"launchpad"];
